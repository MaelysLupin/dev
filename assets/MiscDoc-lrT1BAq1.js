import{f as x,B as w,c as f,a as u,m as l,N as L,g as C,b as n,k,a6 as $,a8 as y,aD as O,_ as A,an as W,q as U,l as M,E as h,u as E,p as F,n as R,T as G,t as J,d as r,r as Z,o as Q,aH as ee,F as te}from"./index-BVTAswxZ.js";import{a as re,s as ae}from"./index-7XWGAyEK.js";import{a as X,b as D,c as se}from"./index-BPhMAICh.js";import{s as ie}from"./index-DjahLXWJ.js";var ne=x`
    .p-skeleton {
        overflow: hidden;
...
`,Ue={root:function(e){var s=e.props;return["p-avatar p-component",{"p-avatar-image":s.image!=null,"p-avatar-circle":s.shape==="circle","p-avatar-lg":s.size==="large","p-avatar-xl":s.size==="xlarge"}]},label:"p-avatar-label",icon:"p-avatar-icon"},Ee=w.extend({name:"avatar",style:Ce,classes:Ue}),Fe={name:"BaseAvatar",extends:L,props:{label:{type:String,default:null},icon:{type:String,default:null},image:{type:String,default:null},size:{type:String,default:"normal"},shape:{type:String,default:"square"},ariaLabelledby:{type:String,default:null},ariaLabel:{type:String,default:null}},style:Ee,provide:function(){return{$pcAvatar:this,$parentInstance:this}}};function S(t){"@babel/helpers - typeof";return S=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},S(t)}function T(t,e,s){return(e=Re(e))in t?Object.defineProperty(t,e,{value:s,enumerable:!0,configurable:!0,writable:!0}):t[e]=s,t}function Re(t){var e=Xe(t,"string");return S(e)=="symbol"?e:e+""}function Xe(t,e){if(S(t)!="object"||!t)return t;var s=t[Symbol.toPrimitive];if(s!==void 0){var o=s.call(t,e);if(S(o)!="object")return o;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}var H={name:"Avatar",extends:Fe,inheritAttrs:!1,emits:["error"],methods:{onError:function(e){this.$emit("error",e)}},computed:{dataP:function(){return C(T(T({},this.shape,this.shape),this.size,this.size))}}},Ie=["aria-labelledby","aria-label","data-p"],Ye=["data-p"],qe=["data-p"],Ke=["src","alt","data-p"];function He(t,e,s,o,d,a){return u(),f("div",l({class:t.cx("root"),"aria-labelledby":t.ariaLabelledby,"aria-label":t.ariaLabel},t.ptmi("root"),{"data-p":a.dataP}),[k(t.$slots,"default",{},function(){return[t.label?(u(),f("span",l({key:0,class:t.cx("label")},t.ptm("label"),{"data-p":a.dataP}),J(t.label),17,Ye)):t.$slots.icon?(u(),M(R(t.$slots.icon),{key:1,class:F(t.cx("icon"))},null,8,["class"])):t.icon?(u(),f("span",l({key:2,class:[t.cx("icon"),t.icon]},t.ptm("icon"),{"data-p":a.dataP}),null,16,qe)):t.image?(u(),f("img",l({key:3,src:t.image,alt:t.ariaLabel,onError:e[0]||(e[0]=function(){return a.onError&&a.onError.apply(a,arguments)})},t.ptm("image"),{"data-p":a.dataP}),null,16,Ke)):E("",!0)]})],16,Ie)}H.render=He;var _e=x`
    .p-overlaybadge {
        position: relative;
    }
